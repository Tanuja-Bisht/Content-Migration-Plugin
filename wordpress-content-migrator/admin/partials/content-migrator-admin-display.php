...
<div class="wrap content-migrator-admin">
    ...
    <div class="card">
                <h2>Upload File</h2>
                <p>Upload a CSV (.csv) file containing the content to migrate. Each row should contain the necessary information for a page or post.</p>
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                                ...
                                <p class="description">Upload a CSV (.csv) file with the content to migrate.</p>
                    </td>
                </tr>
                <tr>
